...
public class GetController {
    ...
    // http://localhost:8080/api/v1/get-api/request2?key=value1&key2=value2
    ...
    // http://localhost:8080/api/v1/get-api/request3?name=sulgi&email=leesulgi66@naver.com&organization=thinkground
