...
import com.example.aroundhub.service.impl.ProductServiceImpl;
...
//@AutoConfigureWebMvc // 이 어노테이션을 ㅌ오해 MockMvc 를 Builder 없이 주입잗을 수 있음
public class ProductControllerTest {
    ...
    void getProductTest() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.productId").exists())    // json path 의 depth 가 깊어지면 .을 추가하여 탐색할 수 있음(ex : $.productId.productIdName)
